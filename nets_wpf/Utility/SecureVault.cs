// THIS CODE IS MODIFIED FROM THE SOURCE CODE GIVEN AT
...
namespace nets_wpf.Utility
{
    /// <summary>
    /// Secure Info Manager.
    /// This class provide a mechanism to store
    /// important information that only the user
    /// (currently log in) can restore.
    /// </summary>
    public class SecureVault
    {
        private string _secureFilePath;

        public SecureVault(string filepath)
        {
            _secureFilePath = filepath;
        }

        public string GetSecureValue()
        {
            string encText = File.ReadAllText(_secureFilePath);
            string decText = DPAPI.Decrypt(encText);
            return decText;
        }

        /// <summary>
        /// Add an info string to the file.
        /// </summary>
        /// <param tag="info">Information to add.</param>
        public void AddSecureInfo(string info)
        {
            File.AppendAllText(_secureFilePath, DPAPI.Encrypt(info));
        }
    }
    ...
    public class DPAPI
    {
        ...
        /// for decryption.
        /// </param>
        /// <param tag="plainTextBytes">
        /// Plaintext data to be encrypted.
        /// </param>
        /// <param tag="entropyBytes">
        /// Optional entropy which - if specified - will be required to
        /// perform decryption.
        /// </param>
        /// <param tag="description">
