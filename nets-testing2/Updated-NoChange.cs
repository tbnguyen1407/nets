...
{
    /// <summary>
    /// Summary description for Updated_NoChange
    /// </summary>
    [TestClass]
    public class Updated_NoChange
    {
        ...
        public void Initialize()
        {
            ...
            string filePath = Path.Combine(dir1, "a.txt");
        ...
        {       
            ...
            else
            {
                ...
                Assert.AreEqual(FileStatus.Updated, pair.FileStatusInSrc,
                    "Source File Status is: " + pair.FileStatusInSrc);
                Assert.AreEqual(FileStatus.NoChange, pair.FileStatusInDes,
