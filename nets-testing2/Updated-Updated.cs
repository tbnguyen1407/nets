...
{
    /// <summary>
    /// Summary description for Updated_Updated
    /// </summary>
    [TestClass]
    public class Updated_Updated
    {
        ...
        [TestMethod]
        public void Updated__Updated()
        {
            FilterPattern filter = new FilterPattern("","");
            Detector detector = new Detector();
            List<FilePair> list = detector.FindDifferences(dir2, dir1, ref filter);
